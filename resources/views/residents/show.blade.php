                ...
                <br>
                    <div class="panel panel-default">
                        ...
                        @endif
                          ...
                          {{-- <a class="btn btn-warning" role="button" href="/repairs/create"><i class="fas fa-plus-circle fa-1x"></i>&nbspADD</a>   --}}
                </div>
                <br>
                    </div>
                    <br>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @endif
                               ...
                               {{-- <a class="btn btn-warning" role="button" href="/violations/create"><i class="fas fa-plus-circle fa-1x"></i>&nbspADD</a>   --}}
                    </div>
                        <br>      
                        </div>         
                        </div>
