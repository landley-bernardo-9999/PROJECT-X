...
{!! Form::open(['action'=>'CoTenantsController@store','method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
<div class="container">
        <div class="row justify-content-center">
            <div class="col-md-7">
                <div class="card"style="padding:6%">
                    <div class="card-header">
                        <h3>Co-Tenant Information</h3>
                    </div>
                <br>
                ...
                <div class="form-group row">
                        <label for="" class="col-md-4 col-form-label text-md-right">Principal Tenant</label>
                    
                    <div class="col-md-6">
                        <select name="principalTenant" id="principalTenant" class="form-control">
